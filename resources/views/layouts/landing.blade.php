    ...
    <div id="headerwrap">
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    <hh1>ConXioN <b><a href="https://github.com/wpouseele/vcloudone-mgmt">vcloudone-mgmt</a></b></h1>
        ...
        <div class="container">
            <div class="row centered">
                ...
                <div class="col-lg-4">
                    ...
                    <p>{{ trans('adminlte_lang::message.see') }} <a href="https://github.com/wpouseele/vcloudone-mgmt">{{ trans('adminlte_lang::message.githubproject') }}</a>, {{ trans('adminlte_lang::message.post') }} <a href="https://github.com/wpouseele/vcloudone-mgmt/issues">{{ trans('adminlte_lang::message.issues') }}</a> {{ trans('adminlte_lang::message.and') }} <a href="hhttps://github.com/wpouseele/vcloudone-mgmt/pulls">{{ trans('adminlte_lang::message.pullrequests') }}</a></p>
                </div>
                <div class="col-lg-4">
    ...
    <div id="c">
        <div class="container">
            <p>
                ...
                <strong>Copyright &copy; 2015 <a href="http://conxion.be">ConXioN</a>.</strong> {{ trans('adminlte_lang::message.createdby') }} <a href="http://github.com/wpouseele">Wim Pouseele</a>. {{ trans('adminlte_lang::message.seecode') }} <a href="https://github.com/wpouseele/vcloudone-mgmt">Github</a>
                <br/>
